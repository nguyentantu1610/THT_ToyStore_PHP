...
$result = $controller->getAllPublisher();
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $result = $controller->deletePublisherById((int)$id);
}
?>
<!DOCTYPE html>
<html class="no-js">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <strong class="card-title">Danh sách nhà xuất bản</strong>
                            <div>
                                <a href="/view/create-publisher.php" class="btn btn-primary btn-sm">
                            ...
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    foreach ($result as $document) {
                                        echo '<tr>';
                                        echo '<td>' . $document['publisherID'] . '</td>';
                                        echo '<td>' . $document['publisherName'] . '</td>';
                                        echo '<td>
                                        <a href="/view/edit-publisher.php?id=' . $document['publisherID'] . '" style="padding: 15px;">
                                            <i class="fa fa-pencil"></i>
                                        </a>
                                        <a href="/view/list-publisher.php?id=' . $document['publisherID'] . '">
