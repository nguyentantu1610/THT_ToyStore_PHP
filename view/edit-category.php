...
$result = $controller->getCategoryById((int)$id);
$controller->updateCategoryById((int)$id);
?>
            ...
            <div class="row">
                <div class="card" style="width: 100%; margin: 14px;">
                    ...
                    <form method="post" id="insert-form" accept-charset="UTF-8">
                        <input readonly value="<?php echo $result['categoryID'] ?>" type="hidden" name="categoryID" id="categoryID" class="form-control">
                            ...
                            <div class="form-group" style="width: 40%;">
                                ...
                                <input type="text" name="categoryName" id="categoryName" class="form-control" 
                                   value=" <?php echo $result['categoryName'] ?> "
                                    placeholder="Vui lòng nhập tên danh mục"  required>
                            </div>
