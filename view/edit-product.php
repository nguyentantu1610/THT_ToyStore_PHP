...
$controller->updateProductById((int)$id);
?>
                    ...
                    <form method="post" id="insert-form" accept-charset="UTF-8">
                        ...
                        <input type="hidden" name="productID" id="productID" value="<?php echo $result['productID'] ?>" />
                            <div class="form-group" style="width: 45%; float: left; margin-right: 5%;">
                                ...
                                <input type="text" name="productName" id="productName" placeholder="Vui lòng nhập tên sản phẩm" class="form-control"  value="<?php echo $result['productName'] ?>" required>
                            </div>
                            <div class="form-group" style="width: 45%; float: left; margin-right: 5%;">
                                <label for="productPrice" class=" form-control-label">Giá</label>
                                <label style="color: red;">(*)</label>
                                <input type="number" name="productPrice" id="productPrice" placeholder="Vui lòng nhập giá" class="form-control"  value="<?php echo $result['productPrice'] ?>" required>
                            </div>
                            <div class="form-group" style="width: 45%; float: left; margin-right: 5%;">
                                <label for="productStock" class=" form-control-label">Số lượng tồn</label>
                                <label style="color: red;">(*)</label>
                                <input type="number" name="productStock" id="productStock" placeholder="Vui lòng nhập số lượng tồn" class="form-control" value="<?php echo $result['productStock'] ?>" required>
                            </div>
                            <div class="form-group" style="width: 45%; float: left; margin-right: 5%;">
                            ...
                            <div class="form-group" style="width: 45%; float: left; margin-right: 5%;">
                                ...
                                <textarea name="productDescription" id="productDescription" rows="9" placeholder="Content..." class="form-control">
                                    <?php echo $result['productDescription'] ?>
                                </textarea>
                            </div>
                            <div class="form-group" style="width: 45%; float: left; margin-right: 5%;">
                                ...
                                <select name="publisherID" id="publisherID" class="form-control">
                                    ...
                                    foreach ($publishers as $item) {
                                        if ($item['publisherID'] == $result['publisherID']) {
                                            echo '<option value="' . $item['publisherID'] . '" selected>' . $item['publisherName'] . '</option>';
                                        } else {
